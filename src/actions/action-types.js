...
export const competitionActions = {
  ...
  COMPETITION_LOAD_ALL_REQUEST: 'COMPETITION_LOAD_ALL_REQUEST',
  COMPETITION_LOAD_ALL_SUCCESS: 'COMPETITION_LOAD_ALL_SUCCESS',
  COMPETITION_LOAD_ALL_FAIL: 'COMPETITION_LOAD_ALL_FAIL',
